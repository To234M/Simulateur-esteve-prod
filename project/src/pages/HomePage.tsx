...
import { useProject, ProjectImage } from '../context/ProjectContext';

const HomePage: React.FC = () => {
  const navigate = useNavigate();
  const { setCurrentImage } = useProject();
  
  const handleImageUploaded = (imageData: ProjectImage) => {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-xl overflow-hidden mb-16">
          <div className="flex flex-col md:flex-row">
            <div className="md:w-1/2 bg-red-50 p-8 flex items-center justify-center">
              <div className="text-center">
                  <Home className="w-24 h-24 text-red-500 mx-auto mb-4" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          />
          <FeatureCard 
            icon={<svg className="w-10 h-10 text-red-500\" viewBox="0 0 24 24\" fill="none\" xmlns="http://www.w3.org/2000/svg">
